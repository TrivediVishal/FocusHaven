...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference("Level.count") do
      post levels_url, params: { level: { created_at: @level.created_at, description: @level.description, updated_at: @level.updated_at } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { created_at: @level.created_at, description: @level.description, updated_at: @level.updated_at } }
